...
@php
  $allPosts = App\Models\Publish_Post::where('creator_id', Auth::user()->id)->count();
  $appCount = App\Models\Api::distinct()->where('creator_id', Auth::user()->id)->count('social_type');
...
@php
  ...
  $Publish_Post = App\Models\Publish_Post::where('status', 'published')->where('creator_id', Auth::user()->id)
