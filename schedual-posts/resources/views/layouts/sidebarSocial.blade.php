  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ route('postsData') }}" class="nav-link outsideLinks"> {{-- table from database --}}
        ...
        <li class="nav-item">
          <a href="{{ route('socialAccounts') }}" class="nav-link outsideLinks">
        ...
        @if (Auth::user()->user_type === 'admin')
          <li class="nav-item">
            <a href="{{ route('services') }}" class="nav-link outsideLinks">
        ...
        @if (Auth::user()->user_type === 'admin')
          <li class="nav-item">
            <a href="{{ route('allUsers') }}" class="nav-link outsideLinks">
