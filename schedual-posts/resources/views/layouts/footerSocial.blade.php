...
<script>
  ...
  $(document).ready(function() {
    ...
    const youtubePageSelectBlock = document.getElementById('youtubePageSelectBlock');
    ...
    function updateSocialIcons(selectedValue) {
      ...
      youtubePageSelectBlock.style.display = selectedValue.includes('youtube') ? 'block' : 'none';
          ...
          var popupContent = `
              ...
              <div class="d-flex justify-content-between align-items-center">
                  <div class="info position-relative">
                    ...
                    <span class="rounded-circle position-absolute socialLogo ${post.type}App"><i class="fab fa-${post.type}"></i></span>
                    <span class="ml-3 accountName" style="font-weight: bold">${post.pageName ? post.pageName : ''} </span>
                  </div>
