...
class UserController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $userAccounts = $user->apis->map(function($query){
            return [
                "account_type" => $query->account_type,
                "account_id" => $query->account_id,
                "account_name" => $query->account_name,
                "email" => $query->email,
                "account_pic" => $query->account_pic,
                "account_link" => $query->account_link,
            ];
        });

        $services = settingsApi::get(['appType', 'appID', 'appSecret', 'apiKey']); // all App on website
