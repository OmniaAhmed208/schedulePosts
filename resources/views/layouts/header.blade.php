...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{asset('tools/assets/vendor/fonts/boxicons.css')}}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('tools/assets/vendor/css/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{asset('tools/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{asset('tools/assets/css/demo.css')}}" />
    ...
    <script src="{{asset('tools/assets/js/config.js')}}"></script>
  </head>
  <body>
    <!-- Layout wrapper -->
