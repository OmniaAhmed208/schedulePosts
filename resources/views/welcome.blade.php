                                                                                    ...
                                                                                    <tr>
                                                                                        <td class=t54 style="width:600px;">
                                                                                            <h1 class=t60 style="margin-bottom:0;Margin-bottom:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:41px;font-weight:800;font-style:normal;font-size:39px;text-decoration:none;text-transform:none;letter-spacing:-1.2px;direction:ltr;color:#06283D;text-align:left;mso-line-height-rule:exactly;mso-text-raise:1px;">
                                                                                                Welcome to E-volve Technology Systems.</h1>
                                                                                        </td>
                                                                                        <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        @if (Route::has('login'))
                                                                                            @auth
                                                                                                ...
                                                                                                @else
                                                                                                    <td class=t74 style="background-color:#06283D;overflow:hidden;width:136px;text-align:center;line-height:40px;mso-line-height-rule:exactly;mso-text-raise:8px;border-radius:14px 14px 14px 14px;margin-right:12px">
                                                                                                        <a href="{{ route('login') }}" class=t80 style="display:block;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:40px;font-weight:600;font-style:normal;font-size:15px;text-decoration:none;letter-spacing:-0.6px;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:8px;">
                                                                                                            Log in
                                                                                                        </a>
                                                                                                    </td>
                                                                                                    <td class=t74 style="width:10px;"></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content p-4">
            <div class="modal-header">
                <h5 class="modal-title mb-4 text-dark">Login</h5>
